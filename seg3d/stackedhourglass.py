...
class StackedUnet(nn.Module):
    ...
    def _make_fc(self, ch_in, ch_out):
        ...
        modules.append(nn.Conv3d(ch_in, ch_out, kernel_size=1))
        modules.append(nn.ReLU(inplace=True))
        if self.batchnorm:
            modules.append(nn.BatchNorm3d(ch_out))
    ...
    def _make_glue(self):
        ...
        for n in range(self.num_stacks):
            ...
            score.append(nn.Conv3d(ch_in, 1, kernel_size=1))
            score_.append(nn.Conv3d(1, ch_in, kernel_size=1))
    ...
    def _make_layers(self):
        ...
        # output layer
        #self.out = nn.Conv3d(self.start_channels, 1, kernel_size=1)
